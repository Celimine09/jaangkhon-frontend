            ...
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div className="bg-gradient-to-br from-yellow-500 to-yellow-600 rounded-lg shadow-md p-6 transition-transform hover:scale-105">
                  <Link href="/admin/user" className="h-full w-full flex flex-col justify-center items-center text-black">
                    <svg
                      className="w-8 h-8"
                      fill="none"
                      stroke="currentColor"
              ...
              <div className="bg-gray-900 rounded-lg border border-gray-800 shadow-md p-6 mb-8">
                <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
                  ...
                  <div className="w-full md:w-auto flex gap-2">
                    <button
                      className={`px-4 py-2 rounded-md text-sm font-medium ${roleFilter === 'all' ? 'bg-yellow-500 text-black' : 'bg-gray-800 text-gray-300 hover:bg-gray-700'}`}
                      onClick={() => setRoleFilter('all')}
                    >
                      All
                    </button>
                    <button
                      className={`px-4 py-2 rounded-md text-sm font-medium ${roleFilter === 'user' ? 'bg-blue-500 text-white' : 'bg-gray-800 text-gray-300 hover:bg-gray-700'}`}
                      onClick={() => setRoleFilter('user')}
                    >
                      Users
                    </button>
                    <button
                      className={`px-4 py-2 rounded-md text-sm font-medium ${roleFilter === 'freelancer' ? 'bg-purple-500 text-white' : 'bg-gray-800 text-gray-300 hover:bg-gray-700'}`}
                      onClick={() => setRoleFilter('freelancer')}
                    >
                      Freelancers
                    </button>
                    <button
                      className={`px-4 py-2 rounded-md text-sm font-medium ${roleFilter === 'admin' ? 'bg-green-500 text-white' : 'bg-gray-800 text-gray-300 hover:bg-gray-700'}`}
                      ...
                      {filteredUsers.length > 0 ? (
                        filteredUsers.map((user) => (
                          ...
                          >
                            ...
                            <td className="py-3">
                              ...
                              >
                                {user.role === "admin" ? "Administrator" : 
                                 user.role === "freelancer" ? "Freelancer" : "User"}
                              </span>
                            </td>
                            <td className="py-3">
                              <span
                            ...
                            <td className="py-3 text-sm text-gray-400">{formatDate(user.createdAt)}</td>
                            <td className="py-3">
